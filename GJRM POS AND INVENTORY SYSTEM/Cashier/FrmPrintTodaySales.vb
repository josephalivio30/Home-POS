Public Class FrmPrintTodaySales
    ...
    Sub LoadTodaySales()
        Try
            ...
            texttoprint &= "TOTAL SALES : " & currencysymbol & Format(CDbl(sales), "#,##0.00") & Environment.NewLine
            ...
            texttoprint &= "TOTAL SALES : " & currencysymbol & Format(CDbl(sales + startAmount + debtpaid) - (expense + refund + debt + adjustment), "#,##0.00") & Environment.NewLine
